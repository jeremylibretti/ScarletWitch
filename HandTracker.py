...
class HandTracker:
    ...
    def run(self):
        ...
        use_training_mode = self.args.use_training_mode
    ...
    ###              ###
        ...
        if not use_training_mode:
            cv.namedWindow(winname, cv.WINDOW_NORMAL)
            cv.resizeWindow(winname, 720, 480)
        ...
        ###                           ###
            ...
            ##### Image Drawing
                    debug_image = self.draw_bounding_rect(use_training_mode, use_brect, debug_image, 
                                                            brect)
    ...
    def draw_bounding_rect(self, training, use_brect, image, brect):
        if use_brect:
            if training:
                # Outer rectangle
    ...
    def draw_inner(self, debug_image, brect, landmark_list, handedness,
                    keypoint_classifier_labels, hand_sign_id,
